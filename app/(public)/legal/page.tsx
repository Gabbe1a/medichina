  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-12 md:px-8">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        <img src="/media/legal/license_1.jpg" alt="Лицензия клиники, страница 1" className="rounded-[24px]" />
        <img src="/media/legal/license_2.jpg" alt="Лицензия клиники, страница 2" className="rounded-[24px]" />
      </div>
