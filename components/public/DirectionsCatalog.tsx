  ...
  return (
    <section id="catalog" className="mt-16">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <span className="text-[11px] font-extrabold uppercase tracking-[0.24em] text-chocolate">Каталог</span>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {services.map((service, index) => (
          ...
          >
            <div className="relative h-36 overflow-hidden bg-[#182332]">
              <Image
            ...
            <div className="p-5">
              <h3 className="text-lg font-extrabold leading-tight text-navy group-hover:text-chocolate transition-colors">{service.title}</h3>
